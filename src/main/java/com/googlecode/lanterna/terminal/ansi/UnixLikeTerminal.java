...
public abstract class UnixLikeTerminal extends ANSITerminal {
    ...
    protected UnixLikeTerminal(InputStream terminalInput,
        ...
        String catchSpecialCharactersPropValue = System.getProperty(
                "com.googlecode.com.googlecode.lanterna.terminal.UnixTerminal.catchSpecialCharacters",
                "");
     ...
     * <p>
     * Please note that this method is called automatically by com.googlecode.lanterna to disable signals unless you define a system
     * property "com.googlecode.com.googlecode.lanterna.terminal.UnixTerminal.catchSpecialCharacters" and set it to the string "false".
     *
     * @param enabled Pass in {@code true} if you want keystrokes to generate system signals (like process interrupt),
     *                {@code false} if you want com.googlecode.lanterna to catch and interpret these keystrokes are regular keystrokes
