 ...
 * are mainly two implementations of this interface, one for having com.googlecode.lanterna automatically spawn a new thread for doing
 * all the processing and leaving the creator thread free to do other things, and one that assumes the creator thread
 * will hand over control to com.googlecode.lanterna for as long as the GUI is running.
 *
 * @author Martin
